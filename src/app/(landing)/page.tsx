  ...
  return (
    <div className="border-b border-gray-200 last:border-b-0">
      <button
        ...
        aria-expanded={open}
      >
        <span className="text-[15px] font-medium text-gray-900 group-hover:text-violet-700 transition-colors pr-8">
          {question}
        </span>
        <ChevronDown
      ...
      <div className="faq-content" data-open={String(open)}>
        <p className="pb-5 px-1 text-sm text-gray-500 leading-relaxed">
          {answer}
        </p>
      </div>
    </div>
...
export default function LandingPage() {
  ...
  const videoSrc = videoPlaying && YOUTUBE_VIDEO_ID
    ? `https://www.youtube.com/embed/${YOUTUBE_VIDEO_ID}?autoplay=1&mute=1&loop=1&playlist=${YOUTUBE_VIDEO_ID}&controls=0&showinfo=0&rel=0&modestbranding=1&playsinline=1`
    : undefined;

  return (
    <div className="min-h-screen bg-white text-gray-900 selection:bg-violet-200">
      {/* ═══════════ NAVIGATION ═══════════ */}
      <nav
        ...
        <div className="max-w-6xl mx-auto px-6 h-16 flex items-center justify-between">
          ...
          <div className="flex items-center gap-3">
            ...
            {ENABLE_SUBSCRIPTIONS ? (
              ...
              <button
                disabled
                className="text-sm font-semibold bg-gray-200 text-gray-400 px-4 py-2 rounded-lg cursor-not-allowed"
              >
                Get Started
              </button>
            )}
        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            <motion.div
              variants={fadeUp}
              custom={0}
              className="inline-flex items-center gap-2 px-3 py-1 rounded-full border border-violet-200 bg-violet-50 text-violet-700 text-xs font-semibold uppercase tracking-wider mb-6"
            >
            ...
            <motion.h1
              variants={fadeUp}
              custom={0.1}
              className="text-4xl sm:text-5xl md:text-6xl font-extrabold tracking-tight leading-[1.1] text-gray-900 mb-5"
            >
            ...
            >
              {ENABLE_SUBSCRIPTIONS ? (
                <Link
                  href="/dashboard"
                  className="inline-flex items-center gap-2 bg-gray-900 text-white px-6 py-3 rounded-xl font-semibold text-sm hover:bg-gray-800 transition-all hover:shadow-lg hover:shadow-gray-900/20 w-full sm:w-auto justify-center"
                >
                ...
                <button
                  disabled
                  className="inline-flex items-center gap-2 bg-gray-100 text-gray-400 px-6 py-3 rounded-xl font-semibold text-sm cursor-not-allowed w-full sm:w-auto justify-center"
                >
                  Coming Soon
                  <ArrowRight className="w-4 h-4" />
                </button>
              ...
              <a
                ...
                className="inline-flex items-center gap-2 bg-white border border-gray-200 text-gray-700 px-6 py-3 rounded-xl font-semibold text-sm hover:bg-gray-50 transition-all w-full sm:w-auto justify-center"
              >
                Book a Demo
              </a>
            </motion.div>
        ...
        <div className="landing-cloud-bg pt-16 pb-20 -mt-4">
          ...
          >
            <div
              ...
              className="rounded-2xl overflow-hidden border border-white/20 shadow-2xl shadow-purple-900/40 bg-gray-900"
            >
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              ...
              <Reveal key={feature.title} delay={i * 0.08}>
                <div className="group rounded-2xl border border-gray-100 p-6 hover:border-violet-200 hover:shadow-lg hover:shadow-violet-500/5 transition-all duration-300">
                  <div
      ...
      <section id="about" className="py-24 px-6 bg-gray-50/80">
        <div className="max-w-5xl mx-auto">
          ...
          {/* Founder Story Quote */}
          <Reveal>
            <div className="bg-white rounded-2xl border border-gray-150 p-8 md:p-10 mb-12 shadow-sm relative overflow-hidden">
              <div className="absolute top-0 left-0 w-2 h-full bg-violet-600" />
              <div className="relative z-10">
                <span className="text-xs font-semibold uppercase tracking-wider text-violet-600 block mb-3">Our Story</span>
                <blockquote className="text-lg md:text-xl font-medium text-gray-800 italic leading-relaxed mb-6">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <cite className="not-italic font-semibold text-gray-900 block text-sm">Ronald Chiong</cite>
                    <span className="text-xs text-gray-500">Founder, SwiprCRM</span>
                  </div>
                </div>
              </div>
            </div>
      ...
      <section id="pricing" className="py-24 px-6 bg-white">
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-6 items-start max-w-3xl mx-auto">
            {/* Individuals */}
            <Reveal delay={0.05}>
              <div className="pricing-card rounded-2xl border border-gray-200 bg-white p-7 flex flex-col">
                <div className="mb-1">
                ...
                {ENABLE_SUBSCRIPTIONS ? (
                  <Link
                    href="/dashboard"
                    className="w-full py-2.5 rounded-lg bg-gray-900 text-white text-sm font-semibold text-center hover:bg-gray-800 transition-colors mb-6"
                  >
                    GET STARTED
                  </Link>
                ) : (
                  <button
                    disabled
                    className="w-full py-2.5 rounded-lg bg-gray-100 text-gray-400 text-sm font-semibold text-center cursor-not-allowed mb-6"
                  >
                    COMING SOON
                  </button>
                )}
            ...
            {/* Teams — highlighted */}
            <Reveal delay={0.1}>
              <div className="pricing-card rounded-2xl border-2 border-violet-500 bg-white p-7 flex flex-col relative">
                ...
                <h3 className="text-lg font-bold text-gray-900 mt-2">Teams</h3>
                <div className="mt-4 mb-6">
                  <span className="text-4xl font-extrabold text-gray-900">
                    $12
                  </span>
      ...
      <section id="faq" className="py-24 px-6 bg-gray-50/80">
        <div className="max-w-3xl mx-auto">
          ...
          <Reveal delay={0.1}>
            <div className="rounded-2xl border border-gray-200 bg-white px-6 divide-y divide-gray-100">
              {FAQ_ITEMS.map((item) => (
                <FAQItem
                  key={item.q}
                  question={item.q}
